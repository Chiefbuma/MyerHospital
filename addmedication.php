            ...
            <div class="table-data" style="width: 70%;">
                ...
                <div class="order">
                    <div class="head">
                        ...
                        <button type="button" style="border: none; background: none; cursor: pointer;" data-toggle="modal" data-target="#medicationModal" aria-label="Add Medication">
                    ...
                    <table id="patientTable" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $medications = $db->displayMedication();
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal<?php echo $fetch['medication_id']; ?>" style="background-color: grey; color: white;">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                                <!-- Delete Modal -->
                                <div class="modal fade" id="deleteModal<?php echo $fetch['medication_id']; ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="deletemedication.php?id=<?php echo $fetch['medication_id']; ?>" class="btn btn-danger" style="background-color: red; color: white;">Delete</a>
                                ...
                                <!-- Edit Modal -->
                                <div class="modal fade" id="editModal<?php echo $fetch['medication_id']; ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            </div>
                                            <form action="updatemedication.php" method="POST">
                                                <div class="modal-body">
                                                    <div class="rounded-container">
                                                        <input type="hidden" name="medication_id" value="<?php echo $fetch['medication_id']; ?>">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label for="formulation<?php echo $fetch['medication_id']; ?>">Formulation</label>
                                                                <select
                                                                    class="form-control"
                                                                    id="formulation<?php echo $fetch['medication_id']; ?>"
                                                                    name="formulation"
                                                                    required>
                                                                    <option value="<?php echo htmlspecialchars($fetch['formulation']); ?>" selected>
                                                                        <?php echo htmlspecialchars($fetch['formulation']); ?>
                                                                    </option>
                                                                    <!-- Add additional options below -->
                                                                    <option value="Tablet">Tablet</option>
                                                                    <option value="Capsule">Capsule</option>
                                                                    <option value="Liquid">Inhaler</option>
