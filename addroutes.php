            ...
            <div class="table-data" style="width: 60%;">
                ...
                <div class="order">
                    <div class="head">
                        ...
                        <button type="button" style="border: none; background: none; cursor: pointer;" data-toggle="modal" data-target="#placeModal" aria-label="Add Branch">
                    ...
                    <table id="patientTable" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal<?php echo $fetch['route_id']; ?>" style="background-color: grey; color: white;">Delete</button>
                                        </div>
                                    </td>
                                ...
                                <!-- Edit Modal -->
                                <div class="modal fade" id="editModal<?php echo $fetch['route_id']; ?>" tabindex="-1" aria-hidden="true">
                                            ...
                                            <form action="updateroute.php" method="POST">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="route_name<?php echo $fetch['route_id']; ?>">Route Name</label>
                                                        <input
                                                            type="text"
                                                            class="form-control"
                                                            id="route_name<?php echo $fetch['route_id']; ?>"
                                                            name="route_name"
                                                            value="<?php echo htmlspecialchars($fetch['route_name']); ?>"
                                                            required>
                                                        <input type="hidden" name="route_id" value="<?php echo $fetch['route_id']; ?>">
                                                    </div>
                                                </div>
                                ...
                                <!-- Delete Modal -->
                                <div class="modal fade" id="deleteModal<?php echo $fetch['route_id']; ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-footer">
                                                <a href="deleteroute.php?id=<?php echo $fetch['route_id']; ?>" class="btn btn-danger" style="background-color: red; color: white;">Delete</a>
                    ...
                    <div class="modal fade" id="placeModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Search Place</h5>
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" id="searchInput" class="form-control" placeholder="Enter place or street name" style="flex: 1;">
                                                <div class="input-group-append">
                                                    <button type="button" class="btn" style="background-color: black; color: white; border-radius: 0.50rem; height: 80%;" onclick="fetchSuggestions()">
                                                        Search
                                                    </button>
                                                </div>
                                            </div>
                                            <select id="place" class="form-control mt-2" style="display: none;" onchange="fetchCoordinates(this.value)">
                                                <option value="">Select a location</option>
                                            </select>
                                            <small>Type the name of the place, click search, and select from the dropdown.</small>
                                        </div>
                                        <!-- Hidden fields for storing latitude and longitude -->
                                        <input type="hidden" name="latitude" id="latitude">
                                        <input type="hidden" name="longitude" id="longitude">
                                        <input type="hidden" name="address" id="place_name">


                                        <!-- Display fields -->
                                        <div class="form-group">
                                            <label for="display_latitude">Latitude</label>
                                            <input type="text" id="display_latitude" class="form-control" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="display_longitude">Longitude</label>
                                            <input type="text" id="display_longitude" class="form-control" readonly>
                                            <input type="hidden" id="display_place_name" class="form-control" readonly>
                                        </div>
                    ...
                    <script>
                        ...
                        function fetchCoordinates(selectedValue) {
                            if (selectedValue) {
                                ...
                                document.getElementById('display_latitude').value = data.lat;
                                document.getElementById('display_longitude').value = data.lon;
                                document.getElementById('display_place_name').value = data.name;
                            }
                        }
                    </script>
