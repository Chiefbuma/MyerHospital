                                ...
                                <div class="container">
                                    <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 20px;">
                                        ...
                                        <div style="display: flex; flex-direction: column; gap: 10px;">
                                            <a id="DdownloadLink" href="shadDailydownload_csv.php" style="text-decoration: underline; color: blue; display: inline-flex; align-items: center;">
                                                <i class="fa fa-download" style="margin-right: 5px;"></i> Daily Summary
                                            </a>
                                ...
                                <script>
                                    $(document).ready(function() {
                                        function updateDownloadLink() {
                                            ...
                                            const baseUrl = "shadDailydownload_csv.php";
                                            const url = `${baseUrl}?from=${fromDate}&to=${toDate}`;
                                            $('#DdownloadLink').attr('href', url);
                                        }
                                ...
                                <table class="table table-bordered table-striped table-hover" id="summaryTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nutrition Assessment Remarks</th>
                                            <th>Revenue</th>
