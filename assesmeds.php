                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="deletechronic.php?id=<?php echo $fetch['medication_use_id']; ?>" class="btn btn-danger">Delete</a>
                            ...
                            ?>
                                <li class="completed">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#editModal<?php echo htmlspecialchars($fetch['patient_id']); ?>">Add Drug </button>
                                    </div>
                                </li>
