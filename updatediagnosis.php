...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($_POST['diagnosis_id'], $_POST['icd_10'], $_POST['diagnosis_name'])) {
            ...
            // Validate form data
            if (empty($diagnosis_id) || empty($icd_10) || empty($diagnosis_name)) {
                throw new Exception("Diagnosis ID, ICD-10, and Diagnosis Name cannot be empty.");
            }
            ...
            throw new Exception("Error: Missing form data.");
        }
