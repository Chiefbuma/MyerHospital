...
try {
	if (isset($_GET['id']) && is_numeric($_GET['id'])) {
		...
		$sql = "DELETE FROM physiotherapy WHERE id = ?";
		...
		if ($stmt->execute()) {
			...
			echo "<script>window.location='assesphysiotherapy.php';</script>";  // Redirect to the chronic list page (adjust the filename as needed)
		} else {
