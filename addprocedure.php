                ...
                <div class="table-data" style="width: 50%;">
                    <div class="order">
                        <div class="head">
                            ...
                            <button type="button" style="border: none; background: none; cursor: pointer;" data-toggle="modal" data-target="#newProcedureModal" aria-label="Add Procedure">
                        ...
                        <table id="patientTable" class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                // Fetch procedure records from the database
                                $procedures = $db->displayProcedures();  // Adjust method to fetch procedures
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between">
                                                <!-- Edit Button -->
                                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#editProcedureModal<?php echo $procedure['procedure_id']; ?>" style="background-color: black; color: white; margin-right: 5px;">Edit</button>
                                                <!-- Delete Button -->
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteProcedureModal<?php echo $procedure['procedure_id']; ?>" style="background-color: grey; color: white;">Delete</button>
                                            </div>
                                        </td>
                                    </tr>

                                    <!-- Edit Procedure Modal -->
                                    <div class="modal fade" id="editProcedureModal<?php echo $procedure['procedure_id']; ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="updateprocedure.php" method="POST">
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="procedure_name<?php echo $procedure['procedure_id']; ?>">Procedure Name</label>
                                                            <input type="text" class="form-control" id="procedure_name<?php echo $procedure['procedure_id']; ?>" name="procedure_name" value="<?php echo htmlspecialchars($procedure['procedure_name']); ?>" required>
                                    ...
                                    <div class="modal fade" id="deleteProcedureModal<?php echo $procedure['procedure_id']; ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="deleteprocedure.php?id=<?php echo $procedure['procedure_id']; ?>" class="btn btn-danger" style="background-color: red; color: white;">Delete</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="newprocedure.php" method="POST">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label for="new_procedure_name">Procedure Name</label>
                                            <input type="text" class="form-control" id="new_procedure_name" name="procedure_name" required>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info" style="background-color: black; color: white;">Submit</button>
