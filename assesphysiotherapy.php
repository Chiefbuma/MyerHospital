                    ...
                    <table id="patientTable" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            while ($fetch = $visit->fetch_array(MYSQLI_ASSOC)) {
                                ...
                                $hiddenClass = ($fetch['assessment'] !== 'Physiotherapy') ? 'hidden-row' : '';
                            ...
                            ?>
                                <tr class="<?php echo $hiddenClass; ?>">
                                    ...
                                    <td><?php echo htmlspecialchars($fetch['visit_date']); ?></td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button class="btn btn-danger" data-toggle="modal" data-target="#deleteModal<?php echo $fetch['id']; ?>">Deactivate</button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="deletephysiotherapy.php?id=<?php echo $fetch['id']; ?>" class="btn btn-danger">Delete</a>
                                    ...
                                    <div class="modal fade" id="nweditModal<?php echo $fetch['patient_id']; ?>" tabindex="-1" aria-labelledby="editModalLabel<?php echo $fetch['patient_id']; ?>" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="savepysiotherapy.php" method="POST">
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group d-flex">
                                                                        ...
                                                                        <select class="form-control w-50" id="scheme_id" name="scheme_id" readonly>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group d-flex">
                                                                        ...
                                                                        <input type="date" class="form-control" id="edit_dob" name="dob" value="<?php echo $fetch['dob']; ?>" readonly>
                                                                    </div>
                                                        ...
                                                        <div class="rounded-container">
                                                            <h5>Physiotherapy Assessment</h5>
                                                            <div class="row">
                                                                ...
                                                                <!-- Pain Level -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="pain_level" class="col-form-label">Pain Level (Scale 0-10)</label>
                                                                    <input type="number" class="form-control" id="pain_level" name="pain_level" min="0" max="10" required>
                                                                </div>

                                                                <!-- Mobility Score -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="mobility_score" class="col-form-label">Mobility Score (1-5)</label>
                                                                    <input type="number" class="form-control" id="mobility_score" name="mobility_score" min="1" max="5" required>
                                                                </div>

                                                                <!-- Range of Motion -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="rom" class="col-form-label">Range of Motion (1-5)</label>
                                                                    <input type="number" class="form-control" id="rom" name="rom" min="1" max="5" required>
                                                                </div>

                                                                <!-- Strength -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="strength" class="col-form-label">Strength (0-5)</label>
                                                                    <input type="number" class="form-control" id="strength" name="strength" min="0" max="5" required>
                                                                </div>

                                                                <!-- Balance -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="balance" class="col-form-label">Balance (1-5)</label>
                                                                    <input type="number" class="form-control" id="balance" name="balance" min="1" max="5" required>
                                                                </div>

                                                                <!-- Walking Ability -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="walking_ability" class="col-form-label">Walking Ability (0-60 min)</label>
                                                                    <input type="number" class="form-control" id="walking_ability" name="walking_ability" min="0" max="60" required>
                                                                </div>

                                                                <!-- Posture Assessment -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="posture" class="col-form-label">Posture Assessment</label>
                                                                    <select class="form-control" id="posture" name="posture" required>
                                                                        <option value="kyphosis">Kyphosis</option>
                                                                        <option value="scoliosis">Scoliosis</option>
                                                                        <option value="anterior_pelvic_tilt">Anterior Pelvic Tilt</option>
                                                                ...
                                                                <!-- Exercise Type -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="exercise_type" class="col-form-label">Exercise Type</label>
                                                                ...
                                                                <!-- Frequency -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="frequency" class="col-form-label">Frequency (Per Week)</label>
                                                                    <input type="number" class="form-control" id="frequency" name="frequency" min="1" max="7" required>
                                                                </div>

                                                                <!-- Duration of Each Session -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="duration" class="col-form-label">Duration of Each Session (Minutes)</label>
                                                                    <input type="number" class="form-control" id="duration" name="duration" min="1" max="60" required>
                                                                </div>

                                                                <!-- Intensity -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="intensity" class="col-form-label">Intensity (1-10)</label>
                                                                    <input type="number" class="form-control" id="intensity" name="intensity" min="1" max="10" required>
                                                                </div>

                                                                <!-- Pain Level Before and After Exercise -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="pain_before" class="col-form-label">Pain Level Before Exercise (0-10)</label>
                                                                    <input type="number" class="form-control" id="pain_before" name="pain_before" min="0" max="10" required>
                                                                </div>

                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="pain_after" class="col-form-label">Pain Level After Exercise (0-10)</label>
                                                                    <input type="number" class="form-control" id="pain_after" name="pain_after" min="0" max="10" required>
                                                                </div>

                                                                <!-- Fatigue Level Before and After Exercise -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="fatigue_before" class="col-form-label">Fatigue Level Before Exercise (0-10)</label>
                                                                    <input type="number" class="form-control" id="fatigue_before" name="fatigue_before" min="0" max="10" required>
                                                                </div>

                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="fatigue_after" class="col-form-label">Fatigue Level After Exercise (0-10)</label>
                                                                    <input type="number" class="form-control" id="fatigue_after" name="fatigue_after" min="0" max="10" required>
                                                                </div>

                                                                <!-- Post-Exercise Recovery Time -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="recovery_time" class="col-form-label">Post-Exercise Recovery Time (1-60 min)</label>
                                                                    <input type="number" class="form-control" id="recovery_time" name="recovery_time" min="1" max="60" required>
                                                                </div>

                                                                <!-- Functional Independence -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="functional_independence" class="col-form-label">Functional Independence (1-5)</label>
                                                                    <input type="number" class="form-control" id="functional_independence" name="functional_independence" min="1" max="5" required>
                                                                </div>

                                                                <!-- Joint Swelling and Muscle Spasms -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="joint_swelling" class="col-form-label">Joint Swelling/Inflammation</label>
                                                                    <select class="form-control" id="joint_swelling" name="joint_swelling" required>
                                                                ...
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="muscle_spasms" class="col-form-label">Muscle Spasms</label>
                                                                    <select class="form-control" id="muscle_spasms" name="muscle_spasms" required>
                                                                        <option value="yes">Yes</option>
                                                                        <option value="no">No</option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <!-- Progress -->
                                                                <div class="col-md-6 form-group-custom">
                                                                    <label for="progress" class="col-form-label">Progress (0-5)</label>
                                                                    <input type="number" class="form-control" id="progress" name="progress" min="0" max="5" required>
                                                                </div>

                                                                <!-- Treatment and Challenges -->
                                                                <div class="col-md-12 form-group-custom">
                                                                    <label for="treatment" class="col-form-label">Treatment</label>
                                                                ...
                                                                <div class="col-md-12 form-group-custom">
                                                                    ...
                                                                    <textarea class="form-control" id="challenges" name="challenges" required></textarea>
                                                                </div>
                                                            ...
                                                            <div class="rounded-container">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group d-flex">
                                                                            <label for="pain_level" class="w-50">Pain Level (Scale 0-10)</label>
                                                                            <input type="number" class="form-control w-50" id="pain_level" name="pain_level" min="0" max="10" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="mobility_score" class="w-50">Mobility Score (1-5)</label>
                                                                            <input type="number" class="form-control w-50" id="mobility_score" name="mobility_score" min="1" max="5" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="rom" class="w-50">Range of Motion (1-5)</label>
                                                                            <input type="number" class="form-control w-50" id="rom" name="rom" min="1" max="5" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="strength" class="w-50">Strength (0-5)</label>
                                                                            <input type="number" class="form-control w-50" id="strength" name="strength" min="0" max="5" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="balance" class="w-50">Balance (1-5)</label>
                                                                            <input type="number" class="form-control w-50" id="balance" name="balance" min="1" max="5" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="walking_ability" class="w-50">Walking Ability (0-60 min)</label>
                                                                            <input type="number" class="form-control w-50" id="walking_ability" name="walking_ability" min="0" max="60" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="posture" class="w-50">Posture Assessment</label>
                                                                            <select class="form-control w-50" id="posture" name="posture" required>
                                                                                <option value=""></option>
                                                                                <option value="kyphosis">Kyphosis</option>
                                                                                <option value="scoliosis">Scoliosis</option>
                                                                                <option value="anterior_pelvic_tilt">Anterior Pelvic Tilt</option>
                                                                        ...
                                                                        <div class="form-group d-flex">
                                                                            <label for="exercise_type" class="w-50">Exercise Type</label>
                                                                            <select class="form-control w-50" id="exercise_type" name="exercise_type" required>
                                                                                <option value=""></option>
                                                                                <option value="aerobic">Aerobic</option>
                                                                                <option value="strengthening">Strengthening</option>
                                                                                <option value="flexibility">Flexibility</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group d-flex">
                                                                            ...
                                                                            <input type="date" class="orm-control w-50" id="visit_date" name="visit_date" required>
                                                                        </div>

                                                                        <div class="form-group d-flex">
                                                                            <label for="frequency" class="w-50">Frequency (Per Week)</label>
                                                                            <input type="number" class="form-control w-50" id="frequency" name="frequency" min="1" max="7" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="duration" class="w-50">Duration of Each Session (Minutes)</label>
                                                                            <input type="number" class="form-control w-50" id="duration" name="duration" min="1" max="60" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="intensity" class="w-50">Intensity (1-10)</label>
                                                                            <input type="number" class="form-control w-50" id="intensity" name="intensity" min="1" max="10" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="pain_before" class="w-50">Pain Level Before Exercise (0-10)</label>
                                                                            <input type="number" class="form-control w-50" id="pain_before" name="pain_before" min="0" max="10" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="pain_after" class="w-50">Pain Level After Exercise (0-10)</label>
                                                                            <input type="number" class="form-control w-50" id="pain_after" name="pain_after" min="0" max="10" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="fatigue_before" class="w-50">Fatigue Level Before Exercise (0-10)</label>
                                                                            <input type="number" class="form-control w-50" id="fatigue_before" name="fatigue_before" min="0" max="10" required>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="fatigue_after" class="w-50">Fatigue Level After Exercise (0-10)</label>
                                                                            <input type="number" class="form-control w-50" id="fatigue_after" name="fatigue_after" min="0" max="10" required>
                                                                        </div>
                                                                    </div>
                                                                    <!-- Full Width Fields -->
                                                                    <div class="col-md-12">
                                                                        <div class="form-group d-flex">
                                                                            <label for="treatment" class="w-50">Treatment</label>
                                                                            <textarea class="form-control w-50" id="treatment" name="treatment" required></textarea>
                                                                        </div>
                                                                        <div class="form-group d-flex">
                                                                            <label for="challenges" class="w-50">Challenges</label>
                                                                            <textarea class="form-control w-50" id="challenges" name="challenges" required></textarea>
                                                                        </div>
                                                                    </div>
