                ...
                <div class="order">
                    ...
                    <table id="schemeTable" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $schemes = $db->display_call_results();
                            $rowNumber = 1; // Initialize row number
                            foreach ($schemes as $scheme) {
                            ?>
                                <tr>
                                    <td><?php echo $rowNumber++; ?></td>
                                    <td><?php echo htmlspecialchars($scheme['Call_result']); ?></td>



                                    <td>
                                        <div class="d-flex justify-content-between">
                                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#editSchemeModal<?php echo $scheme['Call_results_id']; ?>" style="background-color: black; color: white;">Edit</button>
                                            <button class="btn btn-danger" data-toggle="modal" data-target="#deleteSchemeModal<?php echo $scheme['Call_results_id']; ?>">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <!-- Edit Modal -->
                                <div class="modal fade" id="editSchemeModal<?php echo $scheme['Call_results_id']; ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            </div>
                                            <form action="updatecallresults.php" method="POST">
                                ...
                                <!-- Delete Scheme Modal -->
                                <div class="modal fade" id="deleteSchemeModal<?php echo $scheme['Call_results_id']; ?>" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal fade" id="newSchemeModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <form action="newcallresults.php" method="POST">
                                    <div class="modal-body">
                                        <div class="rounded-container">
                                            <input type="hidden" name="Call_results_id" value="<?php echo $scheme['Call_results_id']; ?>">
