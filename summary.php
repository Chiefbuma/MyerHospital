                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#editModal<?php echo $fetchAll['patient_id']; ?>" style="background-color: black; color: white;">View History</button>
                        ...
                        <div class="row justify-content-center pt-4">
                            <div class="col-md-8">
                                <div class="form-group d-flex align-items-center">
                                    ...
                                    <input type="date" name="from_date" id="from_date" value="<?php echo isset($_GET['from_date']) ? $_GET['from_date'] : ''; ?>" class="form-control me-3">

                                    <!-- To Date Filter -->
                                    <label for="to_date" class="mt-2 me-2">To</label>
                                    <input type="date" name="to_date" id="to_date" value="<?php echo isset($_GET['to_date']) ? $_GET['to_date'] : ''; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td>Chronic</td>
                        <td><a href="?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&download_csv=true&type=chronic" class="btn btn-primary mb-3">Download CSV</a></td>
                    </tr>
                    <tr>
                        <td>Nutrition</td>
                        <td><a href="?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&download_csv=true&type=nutrition" class="btn btn-primary mb-3">Download CSV</a></td>
                    </tr>
                    <tr>
                        <td>Psychosocial</td>
                        <td><a href="?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&download_csv=true&type=psychosocial" class="btn btn-primary mb-3">Download CSV</a></td>
                    </tr>
                    <tr>
                        <td>Medication use</td>
                        <td><a href="?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&download_csv=true&type=medication_use" class="btn btn-primary mb-3">Download CSV</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
