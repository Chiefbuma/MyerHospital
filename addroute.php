                ...
                <div class="order">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#editModal<?php echo $fetch['route_id']; ?>" style="background-color: black; color: white;">Edit</button>
                                ...
                                <form action="storeplace.php" method="POST">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="place" class="form-control" placeholder="Enter place or street name" required>
                                            <small>Type the name of the place and select from the suggestions.</small>
                                        </div>
                    ...
                    <script>
                        function initAutocomplete() {
                            ...
                            // Restrict results to geographical locations only
                            autocomplete.setFields(['geometry', 'name']);

                            // When a place is selected, fetch its details
